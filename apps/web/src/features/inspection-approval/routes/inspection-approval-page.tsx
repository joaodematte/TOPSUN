...
import { InspectionApprovalTable } from "@/features/inspection-approval/components/inspection-approval-table";
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
        <UtilitySummaryCard source="inspectionApproval" />

        <CitySummaryCard source="inspectionApproval" />
      </div>
