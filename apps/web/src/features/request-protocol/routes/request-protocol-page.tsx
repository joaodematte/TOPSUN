...
import { RequestProtocolTable } from "@/features/request-protocol/components/request-protocol-table";

export function RequestProtocolPage() {
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      <ProjectStatusCards source="requestProtocol" />
